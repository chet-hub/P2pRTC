...
//		OnSignal(message)
//	}
//	connect.OnOpen = func(dataChannel *P2pSocket) {
//		OnOpen(dataChannel)
//		timer.Stop()
//	}
//	connect.OnMessage = func(dataChannel *P2pSocket,msg []byte) {
//		OnMessage(dataChannel,msg)
//	}
//	connect.OnClose = func(dataChannel *P2pSocket) {
//		OnClose(connect.dataConnection)
//		remove(connect)
//		timer.Stop()
//	}
//	connect.OnError = func(dataChannel *P2pSocket,err []byte) {
